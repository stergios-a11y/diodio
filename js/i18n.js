...
const STRINGS = {
  el: {
    ...
    'print.title':             'Ανάλυση διαδρομής διοδίων',
    'print.generated':         'Δημιουργήθηκε',
    'print.vehicle':           'Όχημα',
    'print.tolerance':         'Ανοχή χρόνου',
    'print.tolerance.unit':    '{n} λεπτά ανά €1',
    'print.summary':           'Σύνοψη',
    'print.advice':            'Συμβουλή',
    'print.tolls':             'Διόδια',
    'print.directions':        'Οδηγίες παράκαμψης',
    'print.exit_at':           'Έξοδος στον κόμβο',
    'print.enter_at':          'επανείσοδος στον κόμβο',
    'print.detour':            'παράκαμψη',
    'print.saves':             'γλιτώνεις',
    'print.no_bypass':         'Δεν υπάρχει εύλογη παράκαμψη.',
    'print.bypass_more':       'Η παράκαμψη κοστίζει περισσότερο από τη διέλευση.',
    'print.footer':            'mydiodia.gr · σύμβουλος διοδίων Ελλάδας',
    'bar.from':                'Από',
    'bar.to':                  'Προς',
  ...
  en: {
    ...
    'print.title':             'Toll route analysis',
    'print.generated':         'Generated',
    'print.vehicle':           'Vehicle',
    'print.tolerance':         'Time tolerance',
    'print.tolerance.unit':    '{n} minutes per €1',
    'print.summary':           'Summary',
    'print.advice':            'Advice',
    'print.tolls':             'Tolls',
    'print.directions':        'Bypass directions',
    'print.exit_at':           'Exit at',
    'print.enter_at':          're-enter at',
    'print.detour':            'detour',
    'print.saves':             'saves',
    'print.no_bypass':         'No reasonable bypass available.',
    'print.bypass_more':       'Bypass costs more than the highway toll.',
    'print.footer':            'mydiodia.gr · Greek toll advisor',
    'bar.from':                'From',
    'bar.to':                  'To',
