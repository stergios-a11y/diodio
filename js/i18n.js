...
const STRINGS = {
  el: {
    ...
    'legend.ramps.entry':      'Κόμβος επανεισόδου',
    ...
    'help.tip.title':          'Συμβουλή',
    'help.tip.body':           'Πάντα επιβεβαίωσε στο Google Maps πριν ακολουθήσεις άγνωστη παράκαμψη.',
    'firsttip.body':           '💡 Πάτα οποιοδήποτε διόδιο για να δεις αν αξίζει να το πληρώσεις ή να το παρακάμψεις.',
    ...
    'sp.bypass.sidetolls.free':       '✓ Καμία πληρωμή σε αυτή την παράκαμψη — εντελώς δωρεάν.',
    'sp.bypass.sidetolls.title.one':  'Θα πληρώσετε 1 πλευρικό διόδιο σε αυτή την παράκαμψη:',
    'sp.bypass.sidetolls.title.many': 'Θα πληρώσετε {n} πλευρικά διόδια σε αυτή την παράκαμψη:',
    'sp.bypass.sidetolls.role.entry': 'είσοδος',
    'sp.bypass.sidetolls.role.exit':  'έξοδος',
    ...
    'rp.action.print':         'Εκτύπωση',
    'rp.action.download':      'Λήψη',
    'rp.action.print.aria':    'Εκτύπωση ή αποθήκευση ως PDF',
    'rp.action.download.aria': 'Λήψη ως αρχείο κειμένου',
    'routes.filter.clear':     'Καθαρισμός',
    'routes.legend.title':     'Κόστος ανά χλμ',
    'routes.legend.free':      '€0',
    'rp.advice.loading':       '💡 Υπολογισμός συμβουλής διαδρομής…',
    'rp.total':                'Σύνολο',
    'rp.save':                 'Κέρδος',
    'rp.extra':                'Επιπλέον',
    'rp.tolls':                'Διόδια',
    'rp.all.tolls':            'Αυτοκινητόδρομος',
    'rp.with.bypass':          'Με παρακάμψεις',
    'rp.diff':                 'Διαφορά',
    'rp.frontal.tolls':        'Μετωπικά διόδια',
    'rp.of.which.on.hw':       'από τα οποία {km} χλμ σε αυτοκινητόδρομο',
    'bar.from':                'Από',
    'bar.to':                  'Προς',
    'bar.origin.placeholder':  'πχ Αθήνα',
    'bar.dest.placeholder':    'πχ Λάρισα',
    ...
    'bar.time.popover.question': 'Πόσα επιπλέον λεπτά θα οδηγούσες για να γλιτώσεις €1 σε διόδια;',
    'bar.time.question.long':  'πόσο χρόνο διατίθεσαι να χάσεις για εξοικονόμιση 1 ευρώ;',
    'bar.time.unit':           'λεπτά',
    ...
    'verdict.avoid.reason':         'Έξοδος {exit}, επανείσοδος στο {entry}. +{min} λεπτά εξοικονόμηση €{cost}.',
    'verdict.marginal.avoid.reason':'Έξοδος {exit}, επανείσοδος στο {entry}. +{min} λεπτά για €{cost} — οριακό αλλά μάλλον αξίζει.',
    ...
    'ramp.entry.tooltip':      'ΕΠΑΝΕΙΣΟΔΟΣ: {name}',
    'ramp.avoid':              'Παράκαμψη: {toll}',
    'bypass.tooltip':          'Παράκαμψη: έξοδος {exit} → επανείσοδος στο {entry} (+{min} λεπτά)',
    ...
    'compare.highway':         'Αυτοκινητόδρομος',
    ...
    'aria.tolerance.pill':     'Ανοχή παράκαμψης (πάτα για ρύθμιση)',
    'aria.overflow.menu':      'Περισσότερες επιλογές',
    'aria.help.dismiss':       'Κλείσιμο οδηγιών',
    'aria.map.controls':       'Χειριστήρια χάρτη',
    'aria.search.tolls':       'Αναζήτηση διοδίων',
    'aria.highway.filter':     'Φίλτρο αυτοκινητοδρόμου',
    'aria.firsttip.dismiss':   'Κλείσιμο επεξήγησης',
    // Legend group labels
    'hwy.A1':                  'ΠΑΘΕ (A1)',
  ...
  en: {
    ...
    'help.tip.title':          'Tip',
    'help.tip.body':           'Always verify with Google Maps before taking an unfamiliar detour.',
    'firsttip.body':           '💡 Tap any toll to see if it\'s worth paying or bypassing.',
    ...
    'sp.bypass.sidetolls.free':       '✓ No tolls on this bypass — fully free.',
    'sp.bypass.sidetolls.title.one':  'You\'ll still pay 1 side toll on this bypass:',
    'sp.bypass.sidetolls.title.many': 'You\'ll still pay {n} side tolls on this bypass:',
    'sp.bypass.sidetolls.role.entry': 'entry',
    'sp.bypass.sidetolls.role.exit':  'exit',
    ...
    'rp.action.print':         'Print',
    'rp.action.download':      'Download',
    'rp.action.print.aria':    'Print or save as PDF',
    'rp.action.download.aria': 'Download as text file',
    'routes.filter.clear':     'Clear',
    'routes.legend.title':     'Cost per km',
    'routes.legend.free':      '€0',
    ...
    'rp.extra':                'Extra time',
    'rp.tolls':                'Tolls',
    'rp.all.tolls':            'Motorway',
    'rp.with.bypass':          'With bypasses',
    'rp.diff':                 'Difference',
    'rp.frontal.tolls':        'Frontal tolls',
    'rp.of.which.on.hw':       'of which {km} km on motorway',
    'bar.from':                'From',
    'bar.to':                  'To',
    'bar.origin.placeholder':  'e.g. Athens',
    'bar.dest.placeholder':    'e.g. Larissa',
    ...
    'bar.time.popover.question': 'How many extra minutes would you drive to save €1 in tolls?',
    'bar.time.question.long':  'how much time are you willing to lose to save €1?',
    'bar.time.unit':           'minutes',
    ...
    'ramp.entry.tooltip':      'RE-ENTER: {name}',
    ...
    'routes.min':              'm',
    'routes.km':               'km',
    'page.vehicle.prefix':     'Prices for:',
    ...
    'aria.tolerance.pill':     'Bypass tolerance (tap to adjust)',
    'aria.overflow.menu':      'More options',
    'aria.help.dismiss':       'Close help',
    'aria.map.controls':       'Map controls',
    'aria.search.tolls':       'Search tolls',
    'aria.highway.filter':     'Highway filter',
    'aria.firsttip.dismiss':   'Close tip',
    'hwy.A1':                  'PATHE (A1)',
