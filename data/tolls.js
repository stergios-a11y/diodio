...
const TOLL_DATA = [
  ...
  },
  {
    ...
    name_gr: "Πλευρικά Γλύφας — Βόρεια είσοδος",
    name_en: "Glyfa side — N entry",
    highway: "A1", highway_name: "PATHE (A1/E75) · Aegean Motorway",
    operator: "Aegean Motorway",
    type: "side", direction: "north", role: "entry",
  ...
  },
  {
    ...
    name_gr: "Πλευρικά Γλύφας — Νότια έξοδος",
    name_en: "Glyfa side — S exit",
    highway: "A1", highway_name: "PATHE (A1/E75) · Aegean Motorway",
    operator: "Aegean Motorway",
    type: "side", direction: "south", role: "exit",
  ...
  },
  {
    ...
    name_gr: "Πλευρικά Βελεστίνου — Βόρεια έξοδος",
    name_en: "Velestino side — N exit",
    highway: "A1", highway_name: "PATHE (A1/E75) · Aegean Motorway",
    operator: "Aegean Motorway",
    type: "side", direction: "north", role: "exit",
  ...
  },
  {
    ...
    name_gr: "Πλευρικά Βελεστίνου — Νότια είσοδος Α",
    name_en: "Velestino side — S entry A",
    highway: "A1", highway_name: "PATHE (A1/E75) · Aegean Motorway",
    operator: "Aegean Motorway",
    type: "side", direction: "south", role: "entry",
  ...
  },
  {
    ...
    name_gr: "Πλευρικά Βελεστίνου — Νότια είσοδος Β",
    name_en: "Velestino side — S entry B",
    highway: "A1", highway_name: "PATHE (A1/E75) · Aegean Motorway",
    operator: "Aegean Motorway",
    type: "side", direction: "south", role: "entry",
  ...
  },
  {
    ...
    name_gr: "Πλευρικά Γυρτώνης — Βόρεια έξοδος",
    name_en: "Gyrtoni side — N exit",
    highway: "A1", highway_name: "PATHE (A1/E75) · Aegean Motorway",
    operator: "Aegean Motorway",
    type: "side", direction: "north", role: "exit",
  ...
  },
  {
    ...
    name_gr: "Πλευρικά Γυρτώνης — Νότια είσοδος",
    name_en: "Gyrtoni side — S entry",
    highway: "A1", highway_name: "PATHE (A1/E75) · Aegean Motorway",
    operator: "Aegean Motorway",
    type: "side", direction: "south", role: "entry",
    direction_label: "Southbound entry at Gyrtoni interchange",
    lat: 39.744893, lng: 22.475308,
    cat1: 0.60, cat2: 0.80, cat3: 2.10, cat4: 2.90,
