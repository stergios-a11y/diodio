...
const TOLL_DATA = [
  ...
  },
  {
    ...
    operator: "Moreas SA",
    type: "frontal", direction_label: "Exit — towards Sparta / Mystras",
  ...
  {
    id: "a5_gavrolimni_west_exit",
    name_gr: "Πλευρικά Γαβρολίμνη — Δυτική έξοδος",
    name_en: "Gavrolimni side — W exit",
    highway: "A5", highway_name: "Nea Odos (A5)",
    operator: "Nea Odos",
    type: "side", direction: "westbound", role: "exit",
    direction_label: "Westbound exit at Gavrolimni interchange",
    lat: 38.174740, lng: 22.239281,
    cat1: 1.75, cat2: 2.50, cat3: 6.30, cat4: 8.85,
    notes: "Side toll booth — paid only when exiting via A5 westbound at Gavrolimni.",
    bypass_directions: null,
  },
  {
    id: "a5_gavrolimni_east_entry",
    name_gr: "Πλευρικά Γαβρολίμνη — Ανατολική είσοδος",
    name_en: "Gavrolimni side — E entry",
    highway: "A5", highway_name: "Nea Odos (A5)",
    operator: "Nea Odos",
    type: "side", direction: "eastbound", role: "entry",
    direction_label: "Eastbound entry at Gavrolimni interchange",
    lat: 38.174763, lng: 22.239736,
    cat1: 1.75, cat2: 2.50, cat3: 6.30, cat4: 8.85,
    notes: "Side toll booth — paid only when entering A5 eastbound at Gavrolimni.",
    bypass_directions: null,
  },
  {
